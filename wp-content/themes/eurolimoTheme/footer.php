      ...
      <footer id="footer">
        <div class="wrapper">
            ...
            <div class="col-md-3">
                <h3>Testimonials</h3>
                <div class="caption">
                    Planning a wedding was extremely stressful, but the advice and support from Driven took away the stress of our journeys. Our Chauffeur was wonderful, extremely professional and nothing was too much trouble. He even took a detour to a picturesque spot which we mentioned on the day, very last minute. I’ll certainly be recommending them to all my friends. Thanks for making our day so special!
                </div>
            </div>
            <div class="col-md-3">
                <h3>Our Team</h3>
